            ...
            <section className="flex flex-col items-center text-center justify-center py-8 sm:p-8 lg:flex-row-reverse lg:px-16 lg:gap-16 xl:gap-44">
                ...
                <div className="flex flex-col items-center lg:items-start lg:text-start">
                    ...
                    <div className="flex flex-col items-center space-y-4 lg:flex-row lg:space-y-0 lg:gap-4 lg:items-start">
                        ...
                        <a href="mailto:engage@swiftpenenterprise.com?subject=Swift%20Pen%20Project&body=Project%20Name%3A%20(Please%20Prefill%20your%20Project%20Name)%0A%0ABrief%20Description%3A%20(Provide%20a%20compelling%20description%20that%20highlights%20your%20vision%20and%20key%20goals%20for%20this%20project)%0A%0AEstimated%20Project%20Timeline%3A%0A%0AStart%20Date%3A%0A%0AEstimated%20Budget%3A%0A%0A(Any%20other%20information)%0A%0ABest%20Regards%2C%0A(Your%20name)"><button className="bg-btn-two-color mt-4 text-white font-medium text-xs p-3 w-30 rounded-md lg:w-fit lg:p-3 lg:-order-1 lg:text-sm button duration-300 hover:bg-lime-500">Get started</button></a>
                    </div>
                </div> 
            </section>
