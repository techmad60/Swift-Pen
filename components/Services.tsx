    ...
    return (
        ...
        <div className={`${montsy.className} flex flex-col justify-center items-center py-8 px-6 max-w-5xl self-center`}>
            ...
            <div className="py-4 px-6 flex flex-col space-y-12 w-full lg:flex-row lg:space-y-0 lg:mt-12 space-x-4 lg:px-0">
                <div className="flex flex-col items-center justify-start gap-4 w-full bg-white p-3 self-center shadow-md lg:mt-0 h-[18rem] rounded-md">
                ...
                <div className="flex flex-col items-center justify-start gap-4 w-full bg-white p-4 self-center shadow-md lg:mt-0 h-[18rem] rounded-md">
                    <div className="flex items-center w-full gap-4 justify-center mt-4">
                        <Image 
                        src={"/images/bullet.svg"}
                        width={12}
