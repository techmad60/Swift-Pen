...
export default function ServicePage () {
    return (
        <>
          <Header />
          <section className={`${montsy.className} bg-dot-pattern lg:px-16 max-w-5xl flex flex-col self-center w-full`}>
            <Services />
            <div className="flex flex-col px-6 text-sm text-slate-600 lg:grid grid-cols-2">
                <div className="text-center flex-flex-col lg:text-start">
                    ...
                    <p className="px-6 py-4"><span className="text-text-color-one">Full-Length Books</span> <br /> From fiction to non-fiction, we deliver complete books that capture your unique voice.</p>
                    <p className="px-6 py-4"><span className="text-text-color-one">Autobiographies & Memoirs</span> <br /> Share your life&apos;s journey with expertly written and compelling narratives.
                    </p>
                    <p className="px-6 py-4"><span className="text-text-color-one">Business Writing</span> <br /> From thought leadership articles to white papers, we help you establish your authority in your field.</p>
                    <p className="px-6 py-4"><span className="text-text-color-one">Pricing</span> <br /> Custom packages available</p>
                </div>
                ...
                <div>
                    <div className="flex flex-col text-center text-sm text-slate-600 lg:text-start">
                        ...
                        <p className="px-6 py-4"><span className="text-text-color-one">Substantive Editing</span> <br/> Improve the structure, content, and overall impact of your manuscript</p>

                        <p className="px-6 py-4"><span className="text-text-color-one">Line Editing</span> <br /> Refine your writing at the sentence level for clarity, flow, and style.</p>

                        <p className="px-6 py-4"><span className="text-text-color-one">Proofreading</span> <br /> Eliminate minor errors to ensure a clean, professional final product.
                        </p>
